//DFS creates a tree for a connected graph, (multiple trees for disconnected graph)
...
//Keep track of all visited vertices to avoid redundant checks (if a subtree of DFS doesn't contain cycle then no point checking again)

static boolean checkCycle(ArrayList<ArrayList<Integer>> list,int v,int curr,boolean[] recStack,boolean[] visited)
{
